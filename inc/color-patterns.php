<?php
/**
 * Fancy Restaurant: Color Patterns
 *
 * @package WordPress
 ...
 */
function fancyrestaurant_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Fancy Restaurant default saturation level.
	 *
	 * @since Fancy Restaurant 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'fancyrestaurant_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.fancyrestaurant-front-page) .entry-title,
...
.colors-custom .fancyrestaurant-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.fancyrestaurant-front-page .panel-content .recent-posts article,
...
.colors-custom.fancyrestaurant-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Fancy Restaurant custom colors CSS.
	 *
	 * @since Fancy Restaurant 1.0
	 *
	 ...
	 */
	return apply_filters( 'fancyrestaurant_custom_colors_css', $css, $hue, $saturation );
}
